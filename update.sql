...
alter table `subscribe_activity` add column `nfr_sec` int(11) NOT NULL DEFAULT '0' COMMENT '禁售秒';
alter table `seckill_activity` add column `nfr_sec` int(11) NOT NULL DEFAULT '0' COMMENT '禁售秒';
...
CREATE TABLE `banner`  (
                           ...
                           `jump_type` int(1) NULL DEFAULT NULL COMMENT '页面跳转类型',
                           `jump_url` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '页面跳转地址',
                           `sort` int(11) UNSIGNED NULL DEFAULT NULL COMMENT '排序',
                           `state` int(1) UNSIGNED NULL DEFAULT 0 COMMENT '状态 0：未上架，1：已上架',
