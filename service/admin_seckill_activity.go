...
func (s *adminSecKillActivity) GetOrders(pageNum int, publisherId string, createdAtStart, createdAtEnd string, priceMin int, priceMax int, payStatus int, searchVal string) {
